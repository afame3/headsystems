...
// Disallow direct access to this file
    ...
    define('DBVERSION', '34'); // update db based on its version, remember to increase to 35 for next version
    ...
    class CommunityControllerInstaller extends CommunityController
    {
        ...
        {
            if(CommunityDefaultItem::checkDefaultCategories('pages')){
                CommunityDefaultItem::addDefaultPagesCategories();
            }
        ...
        private function _installAiPlugin()
        {
            ...
            $this->_enablePlugin('jomsocialredirect');
        ...
        private function _enableModule($module)
        {
            ...
            $defaultPosition = array(
                ...
                'mod_community_pages'=>'js_side_frontpage_bottom',
