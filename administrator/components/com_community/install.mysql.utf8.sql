...
CREATE TABLE IF NOT EXISTS `#__community_connect_users` (
  `connectid` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__community_page_stats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `type` varchar(255) NOT NULL,
  `count` int(11) NOT NULL,
...
INSERT IGNORE INTO `#__community_backgrounds` (`id`, `title`, `description`, `image`, `textcolor`, `placeholdercolor`, `custom`, `published`, `allowcustomtext`, `ordering`) VALUES
(1, 'Purple', 'Purple', 'png', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(2, 'Velvet', 'Velvet', 'png', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(3, 'Black', 'Black', 'png', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(4, 'Maroon', 'Maroon', 'png', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(5, 'Gradient Purple', 'Gradient Purple', 'jpg', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(6, 'Yellow Purple Gradient', 'Yellow Purple Gradient', 'jpg', '030303', 'DDDDDD', 0, 1, 0, 0),
(7, 'Love', 'Love', 'jpg', 'FFFFFF', 'FFFFFF', 0, 1, 0, 0),
(8, 'Stars', 'Stars', 'jpg', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(9, 'Party', 'Party', 'jpg', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0),
(10, 'Pencil', 'Pencil', 'jpg', 'FFFFFF', 'DDDDDD', 0, 1, 0, 0);

CREATE TABLE IF NOT EXISTS `#__community_follower` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__community_pages_category` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `parent` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__community_pages` (
  `id` int(11) NOT NULL auto_increment,
  `permissions` varchar(255) NOT NULL DEFAULT '0',
  `published` tinyint(1) NOT NULL,
  `ownerid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__community_pages_members` (
  `pageid` int(11) NOT NULL,
  `memberid` int(11) NOT NULL,
  `approved` int(11) NOT NULL,
  `permissions` int(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__community_pages_invite` (
`pageid` INT( 11 ) NOT NULL ,
`userid` INT( 11 ) NOT NULL ,
`creator` INT( 11 ) NOT NULL
) ENGINE=MYISAM  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `#__community_ratings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(200) NOT NULL,
  `cid` int(10) NOT NULL,
