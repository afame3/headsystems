                  ...
                  <div id="member-<?php echo $member->id?>"class="itemdiv memberdiv clearfix">
                    ...
                    <div class="body">
                      ...
                      <div id="member-label-<?php echo $member->id?>">
                        <span class="label <?php echo $this->getLabelCss($member->memberstatus)?>"><?php echo JText::_('COM_COMMUNITY_'.strtoupper($member->memberstatus)); ?></span>
                        <?php if ($member->memberstatus !=='approved') {?>
                          <div class="inline position-relative">
                            ...
                            <ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
                              <li>
                                <a href="javascript:void(0);" class="tooltip-success" onClick= "azcommunity.toggleStatus('<?php echo $member->id?>',1)" data-rel="tooltip" title="<?php echo JText::_('COM_COMMUNITY_APPROVE_USER'); ?>">
                                  <span class="green">
                              ...
                              <li>
                                <a href="javascript:void(0);" class="tooltip-warning" onClick= "azcommunity.toggleStatus('<?php echo $member->id?>',0)" data-rel="tooltip" title="<?php echo JText::_('COM_COMMUNITY_REJECT_USER'); ?>">
                                  <span class="orange">
                              ...
                              <li>
                                <a href="javascript:void(0);" class="tooltip-error" onClick= "azcommunity.toggleStatus('<?php echo $member->id?>',2)" data-rel="tooltip" title="<?php echo JText::_('COM_COMMUNITY_DELETE_USER'); ?>">
                                  <span class="red">
    ...
    <div class="widget-box" id="location-box">
      ...
      <div class="widget-body">
        <div class="widget-main">
          ...
          <div class="row-fluid reset-gap">
            <?php $fieldcodelocation = CFactory::getConfig()->get('fieldcodelocation'); ?>
            <?php if ($fieldcodelocation) { ?>
              <div class="span24">
                <table class="table table-bordered reset-gap">
                  <thead>
                    <tr>
                      <th><?php echo JText::_('COM_COMMUNITY_DASHBOARD_LOCATION')?></th>
                  ...
                  <tbody>
                        ...
                        <?php foreach ($this->userCity as $city) {?>
                            <?php
                              ...
                              if (json_last_error() === 0) {
                                $locationTitle = $location['name'] . (!empty($location['desc']) ? ' ('.$location['desc'].')' : '');
                                $city->city = (!empty($location['desc']) ? $location['desc'] : $location['name']);
                                $city->city = preg_replace('/\,[a-zA-Z]{2}$/', '', $city->city);
                              }
                            ?>
                            <?php if (trim($city->city) != '') { ?>
                                <tr>
                                  <td><?php echo $this->escape($locationTitle)?></td>
                    ...
                    <?php } else {?>
                          <tr>
                              <td colspan=2><?php echo JText::_('COM_COMMUNITY_DASHBOARD_NO_LOCATION')?></td>
                          </tr>
                    <?php }?>
                  </tbody>
                </table>
...
<?php else :
    ...
    $document->addScript(JURI::root(true) . '/administrator/components/com_community/assets/js/openstreet.map.js');
    ?>
