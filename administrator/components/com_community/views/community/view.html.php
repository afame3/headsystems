...
class CommunityViewCommunity extends JViewLegacy
{
        ...
        $menus = array(
            ...
            array(
                ...
                'children' => array(
                    ...
                    array(
                        'title' => JText::_('COM_COMMUNITY_PENDING_INVITATIONS'),
                        'url' => 'index.php?option=com_community&view=pendinginvites',
                    ),
                    array(
            ...
            array(
                ...
                'children' => array(
                    ...
                    array(
                        'title' => JText::_('COM_COMMUNITY_CONFIGURATION_THEME_PAGES'),
                        'url' => 'index.php?option=com_community&view=themepages',
                    ),
                    array(
            ...
            array(
                ...
                'children' => array(
                    // array(
                    //     'title' => JText::_('COM_COMMUNITY_CONFIGURATION_REGISTER_LICENSE_TOOLBAR'),
                    //     'url' => 'index.php?option=com_community&view=configuration&cfgSection=license',
                    // ),
                    array(
                    ...
                    array(
                        'title' => JText::_('COM_COMMUNITY_CONFIGURATION_ACCESS_CONTROL_TOOLBAR'),
                        'url' => 'index.php?option=com_config&view=component&component=com_community',
                    ),
                    array(
                    ...
                    array(
                        'title' => JText::_('COM_COMMUNITY_CONFIGURATION_CHAT_TOOLBAR'),
                        'url' => 'index.php?option=com_community&view=configuration&cfgSection=messaging',
                    ),
                    array(
                    ...
                    array(
                        'title' => JText::_('COM_COMMUNITY_CONFIGURATION_REGISTRATIONS_TOOLBAR'),
                        'url' => 'index.php?option=com_community&view=configuration&cfgSection=registration',
                    ),
                    array(
            ...
            array(
                ...
                'children' => array(
                    array(
                        'title' => JText::_('COM_COMMUNITY_TITLE_PAGE_VIEW'),
                        'url' => 'index.php?option=com_community&view=pages',
                    ),
                    array(
                        'title' => JText::_('COM_COMMUNITY_PAGE_CATEGORIES'),
                        'url' => 'index.php?option=com_community&view=pagecategories',
                    ),
                    array(
                        'title' => JText::_('COM_COMMUNITY_TITLE_PAGE_SETTING'),
                        'url' => 'index.php?option=com_community&view=configuration&cfgSection=page',
                    )
                )
            ),
            array(
            ...
            array(
                ...
                'children' => array(
                    ...
                    array(
                        'title' => JText::_('COM_COMMUNITY_MIGRATORS'),
                        'url' => 'index.php?option=com_community&view=migrators',
                    )
                )
            ),
            array(
                ...
                'children' => array(
                    ...
                    array(
                        ...
                        'url' => 'https://www.jomsocial.com/features',
                        'target' => '_blank'
                    ),
                    array(
                        'title' => JText::_('COM_COMMUNITY_TITLE_SUPPORT'),
                        'url' => 'https://www.joomlart.com/forums/jomsocial',
                        'target' => '_blank'
                    )
                )
            )
    ...
    public function getUserCommment()
    {
        ...
        foreach ($datas as $key => $data) {
            ...
            $comment = $CTemplate->escape($comment);

            $datas[$key]->comment = $comment;
        }
...
var i = 0;
jQuery.each(engDatasets, function(key, val) {
  val.color = i;
  ++i;
});
...
engPlotAccordingToChoices = function() {
    ...
    engChoiceContainer.find("input:checked").each(function () {
        ...
        if (data.length > 0) {
        jQuery.plot("#eng-{$type}-plot", data, {
          yaxis: {
            min: 0
          },
          xaxis: {
...
var i = 0;
jQuery.each(datasets2, function(key, val) {
  val.color = i;
  ++i;
});
...
if(checkedChoices.length == 1) {
  ...
  if (data.length > 0) {
    jQuery.plot("#placeholder-2", data, {
      yaxis: {
        min: 0
      },
      xaxis: {
