...
switch ($this->cfgSection) {
	case 'license':
		...
		<div class="row-fluid">
			<div class="span12">
				<?php require_once( dirname(__FILE__) . '/license.php' ); ?>
			</div>
		</div>
		<?php
		break;
	case 'site':
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="space-12"></div>
                <?php require_once( dirname(__FILE__) . '/frontpage_file_upload.php' ); ?>
				<div class="space-12"></div>
				<?php require_once( dirname(__FILE__) . '/likes.php' ); ?>
				<div class="space-12"></div>
				<?php require_once( dirname(__FILE__) . '/followers.php' ); ?>
			</div>
			<div class="span12">
	...
	case 'integrations':
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="space-12"></div>
				<?php require_once( dirname(__FILE__) . '/google_api.php' ); ?>
				<div class="space-12"></div>
				<?php require_once( dirname(__FILE__) . '/twitter_api.php' ); ?>
				<div class="space-12"></div>
				<?php require_once( dirname(__FILE__) . '/linkedin_api.php' ); ?>
			</div>
			<div class="span12">
	...
	case 'registration':
		...
		<div class="row-fluid">
			...
			<div class="span12">
				<?php require_once( dirname(__FILE__) . '/registration_invite.php' ); ?>
			</div>
		</div>
		<?php
		break;
	...
	case 'page':
		...
		<div class="row-fluid">
			<div class="span24">
				<?php require_once( dirname(__FILE__) . '/pages.php' ); ?>
			</div>
		</div>
		<?php
		break;
