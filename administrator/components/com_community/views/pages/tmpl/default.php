...
<table class="table table-bordered table-hover">
	<thead>
		<tr class="title">
			...
			<th>
				<?php echo JText::_('COM_COMMUNITY_PAGES_DESCRIPTION'); ?>
			</th>
			<th>
				<?php echo JText::_('COM_COMMUNITY_CATEGORY'); ?>
			</th>
			<th>
				<?php echo JHTML::_('grid.sort',   JText::_('COM_COMMUNITY_NOTIFICATIONPAGE_ADMIN'), 'c.name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="50">
				<?php echo JHTML::_('grid.sort',   JText::_('COM_COMMUNITY_PUBLISHED'), 'a.published', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="70">
				<?php echo JHTML::_('grid.sort',   JText::_('COM_COMMUNITY_PAGES_MEMBER_S'), 'membercount', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th>
	...
	?>
	<tr>
		<td colspan="7" align="center"><?php echo JText::_('COM_COMMUNITY_PAGES_NONE_CREATED');?></td>
	</tr>
	<?php
		}
	?>
	...
	<tr>
		...
		<td>
			<a href="javascript:void(0);" onclick="azcommunity.editPage('<?php echo $row->id; ?>');">
				<?php echo $row->name; ?>
			</a>
		</td>
		<td>
		...
		<td align="center">
			...
			<span>[ <a href="javascript:void(0);" onclick="azcommunity.changePageOwner('<?php echo $row->id; ?>');"><?php echo JText::_('COM_COMMUNITY_PAGES_CHANGE'); ?></a> ]</span>
		</td>
		<td id="published<?php echo $row->id;?>" align="center" class='center'>
			<?php echo $this->getPublish( $row , 'published' , 'pages,ajaxTogglePublish' );?>
		</td>
		<td align="center">
			<?php echo $row->membercount; ?>
		</td>
		<td>
			<a href="<?php echo JRoute::_(JUri::root().'index.php?option=com_community&view=pages&task=viewpage&pageid='.$row->id); ?>" target="_blank"><?php echo JText::_('COM_COMMUNITY_VIEW')?></a>
		</td>
	</tr>
	<?php endforeach; ?>
</table>
