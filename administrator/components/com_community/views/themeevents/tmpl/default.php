            ...
            <div class="widget-main">
                <table cellspacing="5" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="config[event_sidebar_members_show_total]" value="<?php echo CFactory::getConfig()->get('event_sidebar_members_show_total', 12); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="key" width="150"><?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENT_DEFAULT_SORITNG'); ?></td>
                        <td>
                            <select name="config[event_default_sort_order]">
                                <option value="latest"><?php echo JText::_('COM_COMMUNITY_EVENTS_SORT_CREATION_DATE'); ?></option>
                                <option value="startdate" <?php echo (CFactory::getConfig()->get('event_default_sort_order') == 'startdate') ? 'selected' : ''?>><?php echo JText::_('COM_COMMUNITY_EVENTS_SORT_UPCOMING'); ?></option>
                            </select>
                        </td>
                    </tr>
                </table>
