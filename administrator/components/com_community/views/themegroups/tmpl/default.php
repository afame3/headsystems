            ...
            <div class="widget-main">
                <table cellspacing="5" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="config[group_sidebar_members_show_total]" value="<?php echo CFactory::getConfig()->get('group_sidebar_members_show_total', 12); ?>" >
                        </td>
                    </tr>
                    <tr>
                        <td class="key" width="150"><?php echo JText::_('COM_COMMUNITY_CONFIGURATION_GROUP_DEFAULT_SORITNG'); ?></td>
                        <td>
                            <select name="config[group_default_sort_order]">
                                <option value="latest"><?php echo JText::_('COM_COMMUNITY_GROUPS_SORT_LATEST'); ?></option>
                                <option value="oldest" <?php echo (CFactory::getConfig()->get('group_default_sort_order') == 'oldest') ? 'selected' : ''?>><?php echo JText::_('COM_COMMUNITY_GROUPS_SORT_OLDEST'); ?></option>
                                <option value="alphabetical" <?php echo (CFactory::getConfig()->get('group_default_sort_order') == 'alphabetical') ? 'selected' : ''?>><?php echo JText::_('COM_COMMUNITY_SORT_ALPHABETICAL'); ?></option>
                                <option value="mostactive" <?php echo (CFactory::getConfig()->get('group_default_sort_order') == 'mostactive') ? 'selected' : ''?>><?php echo JText::_('COM_COMMUNITY_GROUPS_SORT_MOST_ACTIVE'); ?></option>
                                <option value="featured" <?php echo (CFactory::getConfig()->get('group_default_sort_order') == 'featured') ? 'selected' : ''?>><?php echo JText::_('COM_COMMUNITY_GROUP_SORT_FEATURED'); ?></option>
                            </select>
                        </td>
                    </tr>
                </table>
