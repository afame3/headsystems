...
<div class="joms-stream-content">
    ...
    <header>
        ...
        <?php endif; ?>
        <?php echo JText::_('COM_COMMUNITY_EVENTS_ACTIVITIES_NEW_EVENT'); ?>
        <!-- Privacy -->
        <div>
            <span class="joms-share-meta date no-line"><?php echo $activity->getCreateTimeFormatted(); ?></span>
        </div>
    </header>
  ...
  <div class="joms-stream-box joms-responsive">
    ...
    <article>
      <a href="<?php echo $this->event->getLink();?>"> <i class="joms-icon-calendar-empty portrait-phone-only"></i> <?php echo JHTML::_('string.truncate', $this->event->title, $truncateVal, true, false ); ?></a>
      ...
      <ul class="list-unstyled content-details">
          ...
          <li><i class="joms-icon-map-marker"></i><?php echo CActivities::format($activity->get('location')); ?></li>
      </ul>
    </article>
</div>
