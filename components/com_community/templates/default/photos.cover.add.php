    ...
    <div class="tab-pane" id="coverupload">
    	<div id="uploadbox">
            ...
            <label class="label-filetype">
                ...
                <input id="uploadCover" type="file" name="uploadCover" size="35" onchange="joms.cover.uploader('<?php echo CRoute::_("index.php?option=com_community&view=photos&task=ajaxCoverUpload&type=".$type."&parentId=".$parentId)?>')"
