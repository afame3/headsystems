...
<tbody>
	...
	<tr>
	    ...
	    <td class="value">
			<div><?php echo $this->escape($user->get('username')); ?></div>
	    </td>
	</tr>
	...
	<tr>
	    ...
	    <td class="value">
			<input type="text" id="name" name="name" value="<?php echo $this->escape($user->get('name'));?>" />
	    </td>
	</tr>
	<?php } ?>
	<!-- email -->
	<tr>
	    ...
	    <td class="value">
			<input type="text" class="input text halfwidth" id="jsemail" name="jsemail" value="<?php echo $this->escape( $user->get('email') ); ?>" />
	...
	<tr>
	    ...
	    <td class="value">
			<input id="jspassword" name="jspassword" class="input password halfwidth" type="password" value="" />
	...
	<tr>
	    ...
	    <td class="value">
			<input id="jspassword2" name="jspassword2" class="input password halfwidth" type="password" value="" />
...
<?php
	...
	else
	{
		...
		?>
			...
			<br/>
			<div>
				<input<?php echo !empty($fbPostStatus) ? ' checked="checked"' : '';?> type="checkbox" id="postFacebookStatus" name="postFacebookStatus" class="input checkbox">
