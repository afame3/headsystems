	...
	<ul class="cFormList cFormVertical cResetList">
		<li>
			...
			<div class="form-field">
				...
				<div id="videoLinkUrlError" style="display:none; color:red;">
		...
		<li>
			<?php echo '<button class="btn btn-primary" onclick="joms.videos.submitLinkVideo();return false;">' . JText::_('COM_COMMUNITY_VIDEOS_LINK') . '</button>'; ?>
		</li>
	</ul>
