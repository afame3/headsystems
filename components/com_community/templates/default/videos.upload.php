...
<form name="uploadVideo" id="uploadVideo" class="form-horizontal" method="post" action="<?php echo CRoute::_('index.php?option=com_community&view=videos&task=upload');?>" enctype="multipart/form-data">
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			<div id="videoTitleError" style="display:none; color:red;">
  ...
  <div class="control-group">
	...
	<div class="control-group">
		<label for="category" class="control-label">
			<?php echo JText::_('COM_COMMUNITY_VIDEOS_CATEGORY'); ?><span class="required-sign"> *</span>
		</label>
		<div class="controls">
			<?php echo $list['category']; ?>
			<div id="videoCategoryError" style="display:none; color:red;">
  ...
  <div class="control-group">
    <label class="control-label"></label>
    <div class="controls">
    	<button class="btn btn-primary" onclick="joms.videos.submitUploadVideo();return false;">
