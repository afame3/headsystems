...
<div class="joms-stream__header">
    ...
    <div class="joms-stream__meta">
        ...
        <?php } else if ($activity->get('pageid')) {
            ...
            ?>
            <span class="joms-stream__reference">
                ▶ <a href="<?php echo CUrlHelper::pageLink($page->id); ?>"><?php echo $page->name; ?></a>
            </span>
        <!-- Target is user profile -->
        <?php } else if ( ( $activity->get('app') == 'profile' ) && ( $activity->get('target') != 0 ) && $activity->get('target') != $user->id ) { ?>
            <span class="joms-stream__reference">
                ▶ <a href="<?php echo CUrlHelper::userLink($activity->target); ?>"><?php echo CFactory::getUser($activity->get('target'))->getDisplayName(false, true); ?></a>
            </span>
        <?php } ?>
