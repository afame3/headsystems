...
<script>
    function joms_change_filter_type(value) {
        var urls = {
            ...
            ?>
            all: '<?php echo html_entity_decode(CRoute::_("index.php?option=com_community&view=events&sort=upcoming")); ?>',
    ...
    function joms_change_filter( value, type ) {
        ...
        if ( type === 'category' ) {
            if ( value ) {
                url = '<?php echo html_entity_decode(CRoute::_("index.php?option=com_community&view=events&categoryid=__cat__")); ?>';
                url = url.replace( '__cat__', value );
            } else {
                url = '<?php echo html_entity_decode(CRoute::_("index.php?option=com_community&view=events")); ?>';
            }
...
if(!$isSearch && ($task == 'display' || !$task) && !$groupid){
?>
...
<?php if ($events) { ?>
    <div class="joms-list--card joms-list--2">
        ...
        <?php
            ...
            for ($i = 0; $i < count($events); $i++) {
                ...
                if ($isMine || $isAdmin || CFactory::getUser()->authorise('community.eventedit', 'com_community')) {
                    $canEdit = true;
                }
                ...
                <div class="joms-list_content <?php echo $event->permission == 1 ? 'event-private' : 'event-public' ?>">
                    <div class="joms-list__item">
                        <div class="joms-list__cover">
                            ...
                            <div class="joms-list__info has-focus__date">
                        ...
                        <div class="joms-list__content">
                            <ul class="joms-list--table">
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo CRoute::_('index.php?option=com_community&view=photos&eventid=' . $event->id); ?>">
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo CRoute::_('index.php?option=com_community&view=videos&eventid=' . $event->id); ?>"><?php echo $event->totalVideos; ?>
                        ...
                        <div class="joms-list__footer joms-padding">
                            <div class="joms-list__creator <?php echo CUserHelper::onlineIndicator($user); ?>">
