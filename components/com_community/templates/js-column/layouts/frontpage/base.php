...
$gridMain = 'joms-col-sm-12';
$jomsRight = JModuleHelper::getModules('joms_sidebar_right_stacked');
if(!empty($jomsRight)) {
    $gridMain = 'joms-col-sm-9';
}
?>
...
<div class="joms-row">
    ...
    <?php if(!empty($jomsRight)) :?>
        <div class="joms-col-sm-3">
            <?php $this->renderModules('joms_sidebar_right_stacked'); ?>
        </div>
    <?php endif;?>
</div>
