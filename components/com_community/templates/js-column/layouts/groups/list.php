...
<div class="joms-list--card joms-list--2">
    ...
    for ( $i = 0; $i < count( $groups ); $i++ ) {
        ...
        if ($isMine || $isAdmin || CFactory::getUser()->authorise('community.groupedit', 'com_community')) {
            $canEdit = true;
        }

    ?>

    <div class="joms-list_content <?php echo $group->approvals == COMMUNITY_PRIVATE_GROUP ? 'group-private' : 'group-public' ?>">
        <div class="joms-list__item">
            ...
            <div class="joms-list__footer joms-padding">
                <div class="joms-list__creator <?php echo CUserHelper::onlineIndicator($creator); ?>">
