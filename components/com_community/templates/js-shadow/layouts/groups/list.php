...
<ul class="joms-list--card">
    ...
    <li class="joms-list__item <?php echo $group->approvals == COMMUNITY_PRIVATE_GROUP ? 'group-private' : 'group-public' ?>"><div class="joms-list__item-inner clearfix">
        ...
        <div class="joms-list__footer joms-padding">
            <div class="joms-avatar-wrap<?php echo CUserHelper::onlineIndicator($creator); ?>">
