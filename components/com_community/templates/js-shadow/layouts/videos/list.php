...
<?php if ($videos) { ?>
    ...
    <ul class="joms-list--video" >
        ...
        foreach ($videos as $video) {
            ...
            <li class="joms-list__item video-permission-<?php echo $video->permissions; ?>"><div class="joms-list__item-inner">
                <a class="joms-video-cover" href="<?php echo $video->getURL(); ?>" title="<?php echo $video->getTitle() ?>"
                    <?php if ($isVideoModal) { ?>
                ...
                <?php } else { ?>
                    ...
                    <div class="joms-block joms-text--light">
                        ...
                        <?php } ?>
                        <span><?php echo '<svg viewBox="0 0 18 18" class="joms-icon"><use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-eye"></use></svg> ' . $video->getHits(); ?></span> ·
                        <span><?php echo '<svg viewBox="0 0 18 18" class="joms-icon"><use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-bubble"></use></svg> ' . $video->getWallCount(); ?></span> ·
                        <span><?php echo '<svg viewBox="0 0 18 18" class="joms-icon"><use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-thumbs-up"></use></svg> ' . $likeCount; ?></span> ·
                        <span><?php echo $video->getLastUpdated(); ?></span>
                    </div>

                <?php } ?>

                <div class="joms-target-user">
