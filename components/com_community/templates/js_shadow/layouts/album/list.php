...
<div class="joms-page">
    ...
    <?php if ($groupId > 0 && $my->authorise('community.create', 'groups.photos.' . $groupId)) { ?>
        <button class="joms-button--add-on-page album joms-button--primary joms-button--small"
    ...
    <?php } else if (($isOwner || $my->id) && ($currentTask == 'myphotos' || $currentTask == 'display' || empty($currentTask)) && CFactory::getUser()->authorise('community.photocreate', 'com_community') && (!$groupId && !$eventId)) { ?>
        <button class="joms-button--add-on-page joms-button--primary joms-button--small" onclick="joms.api.photoUpload();"><?php echo JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_PHOTOS'); ?></button>
    <?php } ?>
    </p>
    <div>
        <?php echo $submenu; ?>
                ...
                <?php
                    ...
                    foreach ($albums as $album) {
                        ...
                        <li class="joms-gallery__item album-permission-<?php echo $album->permissions ?>">
                            <div class="joms-gallery-item-inner">
                            ...
                            <?php if ((($album->isOwner && CFactory::getUser()->authorise('community.photocreate', 'com_community')) || CFactory::getUser()->authorise('community.photodelete', 'com_community') || CFactory::getUser()->authorise('community.photoedit', 'com_community')) && !CAlbumsHelper::isFixedAlbum($album)) { ?>
                                <div class="joms-gallery__options">
                                    ...
                                    <ul class="joms-dropdown">
                                        <?php if (($album->isOwner && !CAlbumsHelper::isFixedAlbum($album) && CFactory::getUser()->authorise('community.photocreate', 'com_community')) || CFactory::getUser()->authorise('community.photoedit', 'com_community')) { ?>
                                            <li>
                                                <a href="<?php echo $album->editLink; ?>"><?php echo JText::_('COM_COMMUNITY_PHOTOS_EDIT'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if ($album->isOwner && !CAlbumsHelper::isFixedAlbum($album) && CFactory::getUser()->authorise('community.photocreate', 'com_community')) { ?>
                                            <?php
                                        ...
                                        <?php if(!CAlbumsHelper::isFixedAlbum($album) && ((CFactory::getUser()->authorise('community.photocreate', 'com_community') && $album->isOwner) || CFactory::getUser()->authorise('community.photodelete', 'com_community'))){ ?>
                                        <li><a href="javascript:"
