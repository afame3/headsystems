    ...
    <ul class="joms-list--card">
        ...
        <?php
            ...
            for ($i = 0; $i < count($events); $i++) {
                ...
                <li class="joms-list__item <?php echo $event->permission == 1 ? 'event-private' : 'event-public' ?>"><div class="joms-list__item-inner clearfix">
                    ...
                    <div class="joms-list__footer joms-padding">
                        <div class="joms-avatar-wrap<?php echo CUserHelper::onlineIndicator($user); ?>">
