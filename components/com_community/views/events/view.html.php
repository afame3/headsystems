    ...
    class CommunityViewEvents extends CommunityView
    {
        ...
        public function display($tpl = null)
        {
            ...
            if (!empty($groupId)) {
                ...
                if (!$page->published) {
                    echo JText::_('COM_COMMUNITY_PAGES_UNPUBLISH_WARNING');
                    return;
                }
            ...
            if($groupId){
                ...
                CHeadHelper::setType('website', JText::_('COM_COMMUNITY_PAGE_EVENT'));
            ...
            if ($groupId) {
                ...
                $title= JText::_('COM_COMMUNITY_PAGE_EVENTS');
            }
        ...
        public function pastevents()
        {
            ...
            if ($groupId) {
                ...
                $title= JText::_('COM_COMMUNITY_EVENTS_PAST_PAGE_TITLE');
            }
        ...
        public function myevents()
        {
            ...
            if($groupId) {
                ...
                $title= JText::_('COM_COMMUNITY_EVENT_PAGE_MINE');
            }elseif($userid != $my->id){
        ...
        public function import($data)
        {
            ...
            if ($groupId) {
                $createLink = CRoute::_('index.php?option=com_community&view=events&groupid='.$groupId.'&task=create');
                $pageTitle = JText::_('COM_COMMUNITY_EVENTS_IMPORT_GROUP_EVENT');
            } else if ($pageId) {
                $createLink = CRoute::_('index.php?option=com_community&view=events&pageid='.$pageId.'&task=create');
                $pageTitle = JText::_('COM_COMMUNITY_EVENTS_IMPORT_PAGE_EVENT');
            } else {
                $createLink =  CRoute::_('index.php?option=com_community&view=events&task=create');
                $pageTitle = JText::_('COM_COMMUNITY_IMPORT_EVENTS');
            }
