        ...
        public function display($id = null)
        {
            ...
            if ($categoryId != null) {
                ...
                if(!empty($groupId)){
                     ...
                     * Opengraph
                     */
                    CHeadHelper::setType('website', JText::sprintf('COM_COMMUNITY_PAGES_VIDEO_LISTING',$page->name));
                }
            }
        ...
        public function video()
        {
            ...
            if ($video->creator_type == VIDEO_PAGE_TYPE) {
                ...
                if (!CGroupHelper::allowViewMedia($pageId)) {
                    ...
                    echo JText::_('COM_COMMUNITY_PAGES_VIDEO_MEMBER_PERMISSION');
                    return;
                }
            ...
            if (!empty($pageId)) {
                ...
                if ($videos) {
                    $this->addSubmenuItem(
                        ...
                        JText::_('COM_COMMUNITY_VIDEOS_PAGE_PENDING'),
                        '',
                        SUBMENU_LEFT
                    );
                }
                ...
                */
                ...
                if ($config->get('enablepages')) {
                    $this->addSubmenuItem(
                        ...
                        JText::_('COM_COMMUNITY_VIDEOS_PAGE_DESC'), '' , false , '' , 'joms-right'
                    );
                }
                ...
                if ($config->get('enableevents')) {
                    $this->addSubmenuItem(
                        ...
                        JText::_('COM_COMMUNITY_VIDEOS_EVENT_DESC'), '' , false , '' , 'joms-right'
                    );
                }
                ...
                if ($config->get('enablegroups')) {
                    $this->addSubmenuItem(
                        ...
                        JText::_('COM_COMMUNITY_VIDEOS_GROUP_DESC'), '' , false , '' , 'joms-right'
                    );
                }
