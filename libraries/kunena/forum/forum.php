...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		if ('5.1.15' == '@' . 'kunenaversion' . '@')
		{
			...
			{
				self::$version = strtoupper('5.1.15');
			}
		}
		else
		{
		...
		self::$version_date  = ('2019-10-27' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2019-10-27';
		self::$version_name  = ('Oberon' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Oberon';
	}
