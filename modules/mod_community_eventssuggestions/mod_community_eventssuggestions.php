...
defined( '_JEXEC' ) or die( 'Unauthorized Access' );
    ...
    $helper = new modcommunityeventssuggestionsHelper();
    $events = $helper->getEventsSuggestions($params);
	$user = CFactory::getUser();

    require(JModuleHelper::getLayoutPath('mod_community_eventssuggestions', $params->get('layout', 'default')));
