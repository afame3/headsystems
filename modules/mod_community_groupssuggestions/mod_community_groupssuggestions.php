...
defined( '_JEXEC' ) or die( 'Unauthorized Access' );
    ...
    $helper = new modcommunitygroupssuggestionsHelper();
	$groups = $helper->getGroupsSuggestions($params);
	$user = CFactory::getUser();

    require(JModuleHelper::getLayoutPath('mod_community_groupssuggestions', $params->get('layout', 'default')));
