...
$document->addStyleSheet(JURI::root(true) . '/modules/mod_community_membersmap/style.css');
$modMembersMap = new modcommunitymembersmapHelper($params);
$showMaps = $modMembersMap->getLocationMap();

require(JModuleHelper::getLayoutPath('mod_community_membersmap', $params->get('layout', 'default')));
