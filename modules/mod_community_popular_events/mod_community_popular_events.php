...
//$document->addStyleSheet(JURI::root(true) . '/modules/mod_community_popular_events/style.css');

$user = CFactory::getUser();

$modCommunityPopularEventsHelper = new modcommunitypopulareventsHelper();
$events = $modCommunityPopularEventsHelper->getEventsData($params);

require(JModuleHelper::getLayoutPath('mod_community_popular_events', $params->get('layout', 'default')));
