...
//$document->addStyleSheet(JURI::root(true) . '/modules/mod_community_popular_groups/style.css');

$user = CFactory::getUser();

$modCommunityPopularGroupsHelper = new modcommunitypopulargroupsHelper();
$groups = $modCommunityPopularGroupsHelper->getGroupsData($params);

require(JModuleHelper::getLayoutPath('mod_community_popular_groups', $params->get('layout', 'default')));
