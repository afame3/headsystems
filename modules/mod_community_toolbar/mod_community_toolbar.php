...
if(is_file(JPATH_BASE.'/components/com_community/libraries/core.php'))
{
    ...
    $newNotificationCount = $newEventInviteCount + $newGroupInviteCount + $newNotificationCount;

    $toolbar_left_logo = $params->get('toolbar_logo','');
    $toolbar_small_logo = $params->get('toolbar_logosm','');
    $logo_url = $params->get('logo_url','');
    $toolbar_background_color = $params->get('toolbar_background_color','0');
    $toolbar_icon_color = $params->get('toolbar_icon_color','0');
