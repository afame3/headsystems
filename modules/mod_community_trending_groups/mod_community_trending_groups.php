...
//$document->addStyleSheet(JURI::root(true) . '/modules/mod_community_trending_groups/style.css');

$user = CFactory::getUser();

$modTopGroupsHelper = new modcommunitytrendinggroupsHelper();
$groups = $modTopGroupsHelper->getGroupsData($params);

require(JModuleHelper::getLayoutPath('mod_community_trending_groups', $params->get('layout', 'default')));
