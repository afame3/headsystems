<?php
    ...
    //$document->addStyleSheet(JURI::root(true) . '/modules/mod_community_trending_photos/style.css');

    $user = CFactory::getUser();

    $modTopPhotosHelper = new modcommunitytrendingphotosHelper();
    $photos = $modTopPhotosHelper->getPhotosData($params);
    //$users = $modTopMembersHelper->getMembersData($params);

    require(JModuleHelper::getLayoutPath('mod_community_trending_photos', $params->get('layout', 'default')));
