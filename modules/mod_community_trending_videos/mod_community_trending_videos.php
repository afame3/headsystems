...
//$document->addStyleSheet(JURI::root(true) . '/modules/mod_community_trending_videos/style.css');

$user = CFactory::getUser();

$modTopVideosHelper = new modcommunitytrendingvideosHelper();
$videos = $modTopVideosHelper->getVideosData($params);
//$users = $modTopMembersHelper->getMembersData($params);

require(JModuleHelper::getLayoutPath('mod_community_trending_videos', $params->get('layout', 'default')));
