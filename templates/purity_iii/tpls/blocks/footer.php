            ...
            <a href="" target="_blank"></a><a href=""></a>.
				...
				<?php if ($this->getParam('t3-rmvlogo', 1)): ?>
					<div class="col-md-4 poweredby text-hide">
						<img src="/templates/purity_iii/images/demo/logo.png" width="200" height="80"
						   target="_blank" <?php echo method_exists('T3', 'isHome') && T3::isHome() ? '' : 'rel="nofollow"' ?>> <strong></strong></a>
					</div>
				<?php endif; ?>
			</div>
		</div>
